...
$(document).ready(function () {
    ...
    const progress = localStorage.getItem("progress") || "71 355 162";
    $(".position")[0].innerHTML = progress;

    function createProgress() {
        const max = +$(".max")[0].innerHTML.replace(/ /g, "");
        const position = +$(".position")[0].innerHTML.replace(/ /g, "");
        const randomNumber = Math.round(Math.random() * 10_00000);
